        ...
        >
            ...
            >
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <div className={`flex gap-3 ${cancelText ? 'w-full' : 'justify-center'}`}>
                        <button 
                            onClick={onConfirm}
                            className={`${cancelText ? 'flex-1' : 'px-12'} px-6 py-2 text-purple-300 hover:text-purple-200 transition border border-purple-500/30 rounded-lg hover:border-purple-400/60 hover:bg-purple-500/10 hover:shadow-[0_0_20px_rgba(168,85,247,0.3)]`}
                        >
                            {confirmText}
                        </button>
                        {cancelText && (
